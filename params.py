...
params_list = [
    ...
    {'name': 'Capture', 'type': 'group', 'children': [
        ...
        {'name': 'Init', 'type': 'group', 'children': [
            {'name': 'models', 'type': 'int', 'value': 1, 'limits': (1, 11)},
        ...
        {'name': 'Processing', 'type': 'group', 'children': [
            ...
            {'name': 'canny_t1', 'type': 'int', 'value': 50},
            {'name': 'canny_t2', 'type': 'int', 'value': 20},
            {'name': 'post_blur', 'type': 'int', 'value': 0},
            {'name': 'accum_w1', 'type': 'float', 'limits': (0, 1), 'value':0.8, 'step': 0.1},
            {'name': 'accum_w2', 'type': 'float', 'limits': (0, 1), 'value':0.3, 'step': 0.1},
    ...
    {'name': 'Prediction', 'type': 'group', 'children': [
        ...
        {'name': 'post_time_lerp', 'type': 'float', 'limits': (0, 1), 'value':0.8, 'step': 0.1},
    ]},
