...
predictor = Predictor(json_path = './models/gart_canny_256.json')
#predictor_1 = Predictor(json_path = './models/gart_canny_256_1.json')
#predictor_2 = Predictor(json_path = './models/gart_canny_256_2.json')
#predictor_3 = Predictor(json_path = './models/gart_canny_256_3.json')
#predictor_4 = Predictor(json_path = './models/gart_canny_256_4.json')
#predictor_5 = Predictor(json_path = './models/gart_canny_256_5.json')

P_list = [predictor]
#P_list = [predictor,predictor_1,predictor_2,predictor_3,predictor_4,predictor_5]
...
def init_capture(capture, output_shape):
    ...
    capture = Capturer(sleep_s = params.Capture.sleep_s,
                       ...
                       models = params.Capture.Init.models
                       )
...
while not params.Main.quit:
    ...
    if params.Capture.enabled:
        ...
        capture.models = params.Capture.Init.models
        
        
        for J in range(1,7):
            if  capture.models == J:
                if premodels != capture.models:
                    premodels = capture.models
                    # predictor = Predictor(json_path = './models/gart_canny_256_1.json')
                    predictor = P_list[J-1]
    ...
    gui.update_image(1, img_out)
    # gui.update_image(2, img_in)
